...
/////////////////////////// 
$mrh_login = "asdasdasd"; // login robo
$mrh_pass1 = "dasdasd"; // pass1 robo
$mrh_pass2 = "idasdasd"; // pass2 robo
/////////////////////////
...
if ($my_crc != $crc)
{
  Header ("Location: http://case-up.ru/?no");
  exit();
}
////////////////////////
...
Header ("Location: http://site.ru/?no"); // Редирект при пополненом балансе
exit();
	//echo "yzhe popolnen";
}
}else{
